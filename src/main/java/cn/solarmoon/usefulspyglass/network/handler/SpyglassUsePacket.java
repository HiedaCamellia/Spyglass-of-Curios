package cn.solarmoon.usefulspyglass.network.handler;
...
public class SpyglassUsePacket {
    ...
    public void handle(SpyglassUsePacket packet, Supplier<NetworkEvent.Context> supplier) {
        ...
        context.enqueueWork(() -> {
            ...
            if (packet.spyglassHandle.equals("spyglassUse")) {
            ...
            else if (packet.spyglassHandle.equals("spyglassStop")) {
            ...
            else if (packet.spyglassHandle.equals("spyglassExchange")) {
                CuriosApi.getCuriosInventory(player).ifPresent(handler -> {
                    if (!spyglass.isEmpty()) {
